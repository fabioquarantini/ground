...
function ground_enqueue_styles() {
	wp_enqueue_style( 'main-style', GROUND_TEMPLATE_URL . '/css/styles.min.css', array(), '1.0', 'all' );
...
function ground_enqueue_scripts() {
	...
	wp_enqueue_script( 'scripts', GROUND_TEMPLATE_URL . '/js/scripts.min.js', array( 'jquery' ), '1.0', true );
