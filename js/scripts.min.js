...
"use strict";jQuery.noConflict(),jQuery(document).ready(function(i){var e={DOMready:function(){i(".js-slider--primary").length>0&&e.slider(),i('[href$=".jpg"], [href$=".png"], [href$=".gif"]').length>0&&e.modal(),i(".js-navicon").length>0&&e.mobileMenu()},slider:function(){i(".js-slider--primary").slick({dots:!0,speed:500})},modal:function(){i('[href$=".jpg"], [href$=".png"], [href$=".gif"]').colorbox({transition:"elastic",speed:400,opacity:.8,slideshow:!0,slideshowSpeed:4e3,itemsnitialWidth:50,initialHeight:50,maxWidth:"90%",maxHeight:"90%"})},mobileMenu:function(){i("body").on("click",".js-navicon",function(){i(this).toggleClass("navicon--active"),i(".navigation--primary").toggleClass("navigation--open")})}};e.DOMready()});
