...
"use strict";var currentLanguage=$("html").attr("lang"),siteUrl=$("body").data("site-url"),templateUrl=$("body").data("template-url");$(document).ready(function(){siteInit.slider(),siteInit.modal(),siteInit.toggleClass(),siteInit.infiniteScroll()}),$(window).on("load",function(){}),$(window).scroll(function(){}),$(window).resize(function(){window.matchMedia("(min-width: 992px)").matches});var siteInit={slider:function(){var t=$(".js-slider");0!=t.length&&t.owlCarousel({loop:!1,dots:!0,margin:0,center:!1,autoHeight:!1,stagePadding:0,responsiveClass:!0,responsive:{0:{autoplay:!0,nav:!1,items:1,dots:!0},992:{items:1,nav:!0,dots:!1}}})},modal:function(){var t=$('[href$=".jpg"], [href$=".png"], [href$=".gif"], [href$=".jpeg"], [href$=".webp"]');0!=t.length&&t.fancybox()},infiniteScroll:function(){var t=$(".js-infinite-container");0!=t.length&&t.infiniteScroll({path:".js-next-page",append:".js-infinite-post",history:!1,scrollThreshold:400,hideNav:".pagination",status:".js-infinite-status"})},toggleClass:function(){var t=".js-toggle-class";0!=$(t).length&&$("body").on("click",t,function(t){t.preventDefault();var e=$(this),i="is-active";if(e.attr("data-toggle-class-name")&&(i=e.data("toggle-class-name")),e.attr("data-toggle-class-selector")){var n=e.data("toggle-class-selector").split(" ");$.each(n,function(t,e){$("."+e).toggleClass(i)})}else e.toggleClass(i)})}};
