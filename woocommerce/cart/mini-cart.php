...
<?php if ( ! WC()->cart->is_empty() ) : ?>
	...
	<ul class="woocommerce-mini-cart cart_list product_list_widget <?php echo esc_attr( $args['list_class'] ); ?>">
        ...
        <h5 class="woocommerce-mini-cart__title"><?php _e('Products in cart', 'ground'); ?></h5>
                                ...
                                <div class="gr-8@md gr-8">
                                    ...
                                    <?php
                                        echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                                            ...
                                            sprintf(
                                                '<div href="%s" class="remove remove_from_cart_button" aria-label="%s" data-product_id="%s" data-cart_item_key="%s" data-product_sku="%s">'.__( 'Remove this item', 'woocommerce' ).'</div>',
    ...
    <div class="woocommerce-mini-cart__details">
