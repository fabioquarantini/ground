        ...
        <div class="gr-12">
            <div data-scroll data-scroll-animation="fade-in-down" data-scroll-repeat>
                <a href="#fade-in-right" data-scroll-to="">
                    <h2>SCROLL TO fade-in-right</h2>
                </a>
            </div>

            <div data-scroll data-scroll-animation="fade-in-down" data-scroll-repeat><h2>fade-in-down</h2></div>
            <div data-scroll data-scroll-animation="fade-in-down"><h2>fade-in-down</h2></div>
            <div data-scroll data-scroll-animation="fade-in-down"><h2>fade-in-down</h2></div>
            <div data-scroll data-scroll-animation="fade-in-down"><h2>fade-in-down</h2></div>
        </div>

        <div class="gr-12">
            <div data-scroll data-scroll-animation="fade-in-down-staggered"><h2>fade-in-down-staggered</h2></div>
            <div data-scroll data-scroll-animation="fade-in-down-staggered"><h2>fade-in-down-staggered</h2></div>
            <div data-scroll data-scroll-animation="fade-in-down-staggered"><h2>fade-in-down-staggered</h2></div>
            <div data-scroll data-scroll-animation="fade-in-down-staggered"><h2>fade-in-down-staggered</h2></div>
        </div>
...
<div class="container margin-top-5 margin-bottom-5">
    <div class="row">
        ...
        <div class="gr-12">
            <div data-scroll data-scroll-animation="fade-in-up"><h2>fade-in-up</h2></div>
            <div data-scroll data-scroll-animation="fade-in-up"><h2>fade-in-up</h2></div>
            <div data-scroll data-scroll-animation="fade-in-up"><h2>fade-in-up</h2></div>
            <div data-scroll data-scroll-animation="fade-in-up"><h2>fade-in-up</h2></div>
        </div>
        ...
        <div class="gr-12">
            <div data-scroll data-scroll-animation="fade-in-up-staggered"><h2>fade-in-up-staggered</h2></div>
            <div data-scroll data-scroll-animation="fade-in-up-staggered"><h2>fade-in-up-staggered</h2></div>
            <div data-scroll data-scroll-animation="fade-in-up-staggered"><h2>fade-in-up-staggered</h2></div>
            <div data-scroll data-scroll-animation="fade-in-up-staggered"><h2>fade-in-up-staggered</h2></div>
        </div>
...
<div class="container margin-top-5 margin-bottom-5" id="fade-in-right">
    <div class="row">
        ...
        <div class="gr-12">
            <div data-scroll data-scroll-animation="fade-in-right"><h2>fade-in-right</h2></div>
            <div data-scroll data-scroll-animation="fade-in-right"><h2>fade-in-right</h2></div>
            <div data-scroll data-scroll-animation="fade-in-right"><h2>fade-in-right</h2></div>
            <div data-scroll data-scroll-animation="fade-in-right"><h2>fade-in-right</h2></div>
        </div>
        ...
        <div class="gr-12">
            <div data-scroll data-scroll-animation="fade-in-right-staggered"><h2>fade-in-right-staggered</h2></div>
            <div data-scroll data-scroll-animation="fade-in-right-staggered"><h2>fade-in-right-staggered</h2></div>
            <div data-scroll data-scroll-animation="fade-in-right-staggered"><h2>fade-in-right-staggered</h2></div>
            <div data-scroll data-scroll-animation="fade-in-right-staggered"><h2>fade-in-right-staggered</h2></div>
        </div>
    ...
    <div class="row">
        ...
        <div class="gr-12">
            ...
            <div>
                ...
                <span class="display-inline-block" data-scroll data-scroll-delay="0.9" data-scroll-speed="6" data-scroll-repeat>
...
<div class="container margin-top-5 margin-bottom-5">
    <div class="row">
        ...
        <div class="gr-12">
            <div data-scroll data-scroll-animation="fade-in-left"><h2>fade-in-left</h2></div>
            <div data-scroll data-scroll-animation="fade-in-left"><h2>fade-in-left</h2></div>
            <div data-scroll data-scroll-animation="fade-in-left"><h2>fade-in-left</h2></div>
            <div data-scroll data-scroll-animation="fade-in-left"><h2>fade-in-left</h2></div>
        </div>
        ...
        <div class="gr-12">
            <div data-scroll data-scroll-animation="fade-in-left-staggered"><h2>fade-in-left-staggered</h2></div>
            <div data-scroll data-scroll-animation="fade-in-left-staggered"><h2>fade-in-left-staggered</h2></div>
            <div data-scroll data-scroll-animation="fade-in-left-staggered"><h2>fade-in-left-staggered</h2></div>
            <div data-scroll data-scroll-animation="fade-in-left-staggered"><h2>fade-in-left-staggered</h2></div>
        </div>
