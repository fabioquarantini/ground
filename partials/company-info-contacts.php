...
<ul class="mt-6 block list-none lg:mt-0 lg:flex lg:flex-row-reverse ">
	...
	<?php if ( GROUND_COMPANY_PHONE ) : ?>
		<li class="js-toggle py-3 text-lg lg:pl-4 lg:text-base lg:py-0"><a class="cursor-pointer"><span class="mr-2"><?php ground_icon( 'phone', 'icon--filled w-6 rounded-full text-white bg-purple-600 p-1 dark:text-white' ); ?></span> <?php echo GROUND_COMPANY_PHONE; ?></a></li>
	<?php endif; ?>
	<?php if ( GROUND_COMPANY_WHATSAPP ) : ?>
		<li class="js-toggle py-3 text-lg lg:text-base lg:py-0"><a class="cursor-pointer"><span class="mr-2"><?php ground_icon( 'whatsapp', 'icon--filled w-6 rounded-full text-white bg-green-400 p-1 dark:text-white' ); ?></span> <?php echo GROUND_COMPANY_WHATSAPP; ?></a></li>
	<?php endif; ?>
</ul>
<?php endif; ?>
