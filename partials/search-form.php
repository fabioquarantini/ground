<div class="search">
	...
	<div class="search__content">
		<form class="form form--search" id="js-ajax-search" method="get" action="<?php echo home_url( '/' ); ?>">
			...
			<button class="form__button" type="submit"><?php ground_icon( 'magnifying-glass', 'form__icon' ); ?></button>
			<div class="search__spinner spinner js-ajax-search-spinner"></div>
		</form> <!-- End .form -->
		<a class="search__close js-toggle js-magnet js-cursor-hover" href="#" data-toggle-target=".search" data-toggle-class-name="is-search-open">
