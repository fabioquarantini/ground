<div class="relative overflow-hidden py-12 lg:mb-9 bg-gray-100 transform -translate-x-2/4 w-screen ml-1/2 lg:py-28 lg:rounded-theme lg:ml-0 lg:translate-x-0 lg:w-auto">
		...
		<div class="grid grid-cols-12 gap-x-6">
			<div class="col-span-full lg:col-start-2 lg:col-span-3">
				<?php if ( apply_filters( 'woocommerce_show_page_title', true ) ) : ?>
					<h1 class="color-black text-3xl font-bold py-3 lg:py-0" data-scroll data-scroll-animation="fade-in-down-staggered"><?php woocommerce_page_title(); ?></h1>
				<?php endif; ?>
			</div>
