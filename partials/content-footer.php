<footer class="relative py-16">
	<div class="container md:flex md:justify-between space-y-9 md:space-y-0">
		...
		<div>
			<?php // get_template_part( 'partials/navigation', 'about' ); ?>
		</div>
		<div>
			<?php // get_template_part( 'partials/navigation', 'support' ); ?>
		</div>
		<div>
			<?php // get_template_part( 'partials/navigation', 'legal' ); ?>
		</div>
	</div>
	...
	<div class="container md:flex md:items-center md:justify-start md:pt-16 mt-9 md:space-x-9">
		...
		<div class="md:border-l border-gray-400">
			...
			<div class="flex items-center md:justify-center md:space-x-6">
				...
				<p class="md:pl-6 pr-3"><?php _e( 'Seguici sui social network', 'ground' ); ?></p>
